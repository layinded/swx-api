...
from swx_core.models.user import UserUpdate, UserUpdatePassword
...
@patch("swx_core.services.user_service.update_user_profile_service")
...
@patch("swx_core.services.user_service.get_user_by_id_service")
...
@patch("swx_core.services.user_service.update_password_service")
...
@patch("swx_core.services.user_service.delete_user_service")
