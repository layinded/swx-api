...
@patch("swx_core.services.auth_service.login_user_service")
...
@patch(
    "swx_core.services.auth_service.login_user_service",
...
@patch("swx_core.services.auth_service.login_social_user_service")
...
@patch("swx_core.services.auth_service.refresh_access_token_service")
...
@patch(
    "swx_core.services.auth_service.refresh_access_token_service",
...
@patch("swx_core.services.auth_service.register_user_service")
...
@patch("swx_core.services.auth_service.logout_service")
...
@patch("swx_core.services.auth_service.recover_password_service")
...
@patch("swx_core.services.auth_service.reset_password_service")
...
@patch(
    "swx_core.services.auth_service.reset_password_service",
