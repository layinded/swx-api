...
from swx_core.models.user import UserCreate, UserNewPassword
...
@patch("swx_core.repositories.user_repository.authenticate_user")
@patch(
    "swx_core.security.refresh_token_service.create_access_token",
    return_value="mock_access_token",
)
@patch(
    "swx_core.security.refresh_token_service.create_refresh_token",
...
@patch("swx_core.repositories.user_repository.authenticate_user", return_value=None)
@patch(
    "swx_core.utils.language_helper.translate",
...
@patch(
    "swx_core.security.refresh_token_service.verify_refresh_token",
...
@patch("swx_core.repositories.user_repository.create_user")
...
@patch(
    "swx_core.repositories.user_repository.get_user_by_email",
    return_value=mock_user,
)
@patch(
    "swx_core.security.password_security.generate_password_reset_token",
    return_value="mock_reset_token",
)
@patch("swx_core.email.email_service.send_email")
...
@patch("swx_core.repositories.user_repository.get_user_by_email", return_value=None)
@patch(
    "swx_core.utils.language_helper.translate", return_value="User email not found"
)
...
@patch(
    "swx_core.security.password_security.verify_password_reset_token",
...
@patch(
    "swx_core.security.password_security.get_password_hash",
    return_value="hashed_new_pass",
)
@patch("swx_core.security.refresh_token_service.revoke_all_tokens")
