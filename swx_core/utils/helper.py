...
def resolve_base_path(name: str, module: str | None = None) -> tuple[str, str, str | None, str]:
    ...
    Examples:
        - "v1/product"  -> ("swx_app", "swx_app", "v1", "product")
        - "product"     -> ("swx_app", "swx_app", None, "product")
        - "core/user"   -> ("swx_core", "swx_core", None, "user")
    """
    version = None
    ...
    if name.startswith("core/") or (module and "swx_core" in module):
        return "swx_core", "swx_core", version, resource_name
    return "swx_app", "swx_app", version, resource_name
